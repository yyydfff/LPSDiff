# Reparameterizing Restoration States: Latent Phase-State Diffusion for Low-Dose CT Denoising
...
- The Hybrid-DL-IR dataset can be found from:[Hybrid-DL-IR-Data](https://data.mendeley.com/datasets/j7khwb3z3r/1)
